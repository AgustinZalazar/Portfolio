...
const Header = () => {
    return <div className="group h-screen w-full snap-start">
        ...
        <div className="relative  flex flex-wrap h-screen w-full items-center justify-around">
            <GradientBall width="w-36 md:w-60" height="h-40 md:h-56" bottom="bottom-0" left="-left-28" />
            <div>
                <div className="overflow-hidden mb-5">
                    <div className="group-hover/wrap:translate-y-full group-hover:animate-reveal">
                        <h1 className='text-4xl md:text-7xl font-secondary text-white font-bold mb-3'>Agustin Zalazar</h1>
                    </div>
                </div>
            ...
            <GradientBall width="w-20 md:w-32" height="h-24 md:h-32" top="top-0" right="-right-4 md:-right-12" />
        </div>
    </div>
}
